        ...
        <SimpleBar className="h-n80">
          <div className="p-4">
            ...
            <div className="flex gap-4 mb-7">
              ...
              >
                <span className="flex items-center">
                  <Icon icon="solar:align-right-line-duotone" width="20" className="me-2" /> RTL
                </span>
              </Button>
            </div>
              ...
              {themeColors.map((theme, index) => (
                ...
                >
                  <Tooltip content={theme.disp} placement="top" animation="duration-500">
                    ...
                    >
                      {activeTheme === theme.disp && <Icon className="text-white" icon={"check"} />}
                    </label>
                  </Tooltip>
                </span>
              ))}
            ...
            <div className="flex flex-wrap  gap-4 mb-7">
              ...
              >
                <span className="flex items-center">
                  <Icon icon="solar:slider-vertical-line-duotone" width="20" className="me-2" />
                  Vertical
                </span>
              </Button>
              <Button
              ...
              >
                <span className="flex items-center">
                  <Icon icon="solar:slider-horizontal-line-duotone" width="20" className="me-2" />
                  Horizontal
                </span>
              </Button>
            </div>
            ...
            <div className="flex flex-wrap  gap-4 mb-7">
              ...
              >
                <span className="flex items-center">
                  <Icon icon="solar:quit-full-screen-square-line-duotone" width="20" className="me-2" />
                  Boxed
                </span>
              </Button>
              <Button
              ...
              >
                <span className="flex items-center">
                  <Icon icon="solar:full-screen-square-line-duotone" width="20" className="me-2" />
                  Full
                </span>
              </Button>
            </div>
            ...
            />
            <div>
              <p className="dark:text-applinksubtext">Current Value: {isBorderRadius}</p>
            </div>
          </div>
        </SimpleBar>
      </Drawer>
